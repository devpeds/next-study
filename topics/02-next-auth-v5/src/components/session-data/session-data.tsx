  ...
  return (
    <section className="flex flex-col basis-2xs items-center p-8 rounded-xl bg-gray-100 dark:bg-gray-800 relative overflow-hidden">
      ...
      <p className="text-lg mt-2">
        Session from{" "}
        <code className="bg-gray-200 dark:bg-gray-400 text-red-500 dark:text-red-700 rounded-sm px-2 py-1">
          {apiName}
        </code>
      </p>
      <pre className="mt-6 p-4 w-full h-full bg-white rounded-lg overflow-scroll">
